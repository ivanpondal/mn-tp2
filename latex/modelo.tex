...
Tenemos que ver que el algortimo descripto calcula efectivamente $x^{(k+1)} = P_2^{(k)}x^{k}$:
\begin{proposition}
...
\newline
Teniendo en cuenta estas informacion, la igualdad nos queda de la siguiente forma:
\begin{equation*}
          \begin{aligned}
